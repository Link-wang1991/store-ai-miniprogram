...
const HOME = 'M3 10 L12 3 L21 10 V20 A1 1 0 0 1 20 21 H15 V14 H9 V21 H4 A1 1 0 0 1 3 20 V10 Z'
...
const TABS = [
  ...
  { path: '/pages/home/index', label: '首页', icon: S(HOME, GRAY), iconActive: S(HOME, GREEN) },
